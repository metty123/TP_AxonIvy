 ...
 * @since <%=date%>
 */
public class ConfigurationPropertiesPanel extends RichDialogGridBagPanel implements IRichDialogPanel {
  /** Serial version id */
  ...
  private RTable getPropertiesTable() {
    if (propertiesTable == null) {
      ...
      propertiesTable
          .setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons false /version \"3.0\"/columns {{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Name\\\"\"/field \"\"/columnWidth \"150\"}{/result \"result=IF(entry.getUserInterfaceFormat() == ch.ivyteam.ivy.system.UserInterfaceFormat.PASSWORD,  \\r\\n  IF(entry.value.isEmpty(), \\\"\\\", \\\"********\\\"), \\r\\nIF(entry.getUserInterfaceFormat() == ch.ivyteam.ivy.system.UserInterfaceFormat.DAYTIME, \\r\\n  \\\"\\\" + (entry.getIntValue()/1000/60/60).format(\\\"00\\\") + \\\":\\\" + (entry.getIntValue()/1000/60%60).format(\\\"00\\\"),\\r\\nentry.value))\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Value\\\"\"/field \"\"/columnWidth \"120\"}{/result \"result=entry.getDefaultValue()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Default\\\"\"/field \"\"/columnWidth \"120\"}{/result \"result=IF(entry.getDescriptionReference().length() > 0,\\r\\n\\tivy.cms.co(\\\"/Help/SystemProperties/PropertyDescriptions/\\\" + entry.getDescriptionReference()),\\r\\n\\t\\\"\\\"\\r\\n)\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Description\\\"\"/field \"\"}}}");
