[Ivy]
[>Created: Tue Jul 26 09:33:08 ICT 2016]
1562B41B0A383BF1 3.18 #module
...
Ss0 f0 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
Ss0 f0 method start(ch.ivyteam.ivy.application.ISystemPropertyProvider) #txt
Ss0 f0 disableUIEvents false #txt
Ss0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<ch.ivyteam.ivy.application.ISystemPropertyProvider propertyProvider> param = methodEvent.getInputArguments();
' #txt
...
<elementInfo>
    <language>
        <name>start(ISystemPropertyProvider)</name>
    </language>
</elementInfo>
' #txt
Ss0 f0 54 38 20 20 13 0 #rect
Ss0 f0 @|RichDialogInitStartIcon #fIcon
Ss0 f1 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
Ss0 f1 51 211 26 26 14 0 #rect
Ss0 f1 @|RichDialogProcessEndIcon #fIcon
Ss0 f3 actionDecl 'ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData out;
' #txt
Ss0 f3 actionTable 'out=in;
' #txt
Ss0 f3 actionCode 'import ch.ivyteam.ivy.system.ISystemProperty;
import ch.ivyteam.ivy.system.UserInterfaceFormat;
java.util.List allProps = in.propertyProvider.getSystemProps();

out.properties = [];
for (ISystemProperty prop : allProps)
{
...
' #txt
Ss0 f3 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f5 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
Ss0 f5 actionDecl 'ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData out;
' #txt
...
Ss0 f6 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
' #txt
Ss0 f6 responseActionDecl 'ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData out;
' #txt
Ss0 f6 responseMappingAction 'out=in;
' #txt
Ss0 f6 windowConfiguration '{/title "System Property Editor"/width 0 /height 0 /centered true /resizable true /maximized false /close_after_last_rd true }' #txt
...
Ss0 f7 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f10 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f12 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f14 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f16 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f13 actionDecl 'ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData out;
' #txt
Ss0 f13 actionTable 'out=in;
' #txt
Ss0 f13 actionCode in.properties.elementChanged(in.selectedProperty); #txt
Ss0 f13 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
Ss0 f20 actionDecl 'ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData out;
' #txt
Ss0 f20 actionTable 'out=in;
' #txt
Ss0 f20 actionCode 'in.selectedProperty = panel.propertiesTable.#selectedListEntry as ch.ivyteam.ivy.system.ISystemProperty;
' #txt
Ss0 f20 type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
...
>Proto Ss0 .type ch.ivyteam.ivy.admin.tool.SystemPropertyList.SystemPropertyListData #txt
>Proto Ss0 .processKind RICH_DIALOG #txt
>Proto Ss0 .ui2RdDataAction 'out.selectedProperty=panel.propertiesTable.#selectedListEntry as ch.ivyteam.ivy.system.ISystemProperty;
' #txt
