[Ivy]
[>Created: Tue Apr 24 12:14:29 CEST 2012]
1314C57F440B4628 3.17 #module
...
Qs0 f0 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f1 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
Qs0 f1 59 363 26 26 14 0 #rect
Qs0 f1 @|RichDialogProcessEndIcon #fIcon
Qs0 f3 guid 1180E4CA043D915F #txt
Qs0 f3 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
Qs0 f3 actionDecl 'ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData out;
' #txt
...
Qs0 f4 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
Qs0 f4 guid 1180E4CB12BEE6A1 #txt
Qs0 f4 851 355 26 26 14 0 #rect
Qs0 f4 @|RichDialogEndIcon #fIcon
Qs0 f5 expr out #txt
Qs0 f5 864 50 864 355 #arcP
Qs0 f6 actionDecl 'ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData out;
' #txt
Qs0 f6 actionTable 'out=in;
' #txt
Qs0 f6 actionCode 'import com.ulcjava.base.application.util.Insets;
...
for (int i=0; i<in.actionCommandsForButtons.size(); i++)
{
	...
	button = new RButton();
	button.margin = new Insets(0, 20, 0, 20);
	button.text = in.isCustomButtonsMode? in.textsForButtons.get(i): "<%= ivy.cms.co(\"/Buttons/" + buttonName + "\")%>";
...
' #txt
Qs0 f6 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f8 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f10 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f11 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f14 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
Qs0 f15 actionDecl 'ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData out;
' #txt
Qs0 f15 actionTable 'out=in;
' #txt
Qs0 f15 actionCode 'out.isCustomButtonsMode = false;' #txt
Qs0 f15 type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
...
' #txt
>Proto Qs0 .type ch.ivyteam.ivy.commondialogs.QuestionDialog.QuestionDialogData #txt
>Proto Qs0 .processKind RICH_DIALOG #txt
>Proto Qs0 .rdData2UIAction 'panel.iconLabel.iconUri="/Icons/Large/"+in.icon;
