[Ivy]
[>Created: Wed Oct 19 11:41:15 ICT 2016]
1314CA6119CDF698 3.18 #module
...
Ls0 f0 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f1 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f1 43 243 26 26 14 0 #rect
Ls0 f1 @|RichDialogProcessEndIcon #fIcon
Ls0 f3 guid 11812DC43473EE7C #txt
Ls0 f3 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f3 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
...
Ls0 f4 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f4 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
...
Ls0 f5 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f7 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f7 guid 11812DCB6702ACDB #txt
Ls0 f7 611 459 26 26 14 0 #rect
Ls0 f7 @|RichDialogEndIcon #fIcon
Ls0 f9 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f9 actionTable 'out=in;
' #txt
Ls0 f9 actionCode 'in.error = panel.login(ivy.session, in.userName, in.password);' #txt
Ls0 f9 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f11 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f13 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f14 richDialogId ch.ivyteam.ivy.commondialogs.ErrorDialog #txt
Ls0 f14 startMethod showError(java.lang.Throwable,Boolean,Boolean) #txt
Ls0 f14 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
' #txt
Ls0 f14 requestActionCode 'String loginFailedMessage = ivy.cms.co("/labels/loginFailed");
param.error = new Exception(loginFailedMessage);
param.showCopyButton = false;
param.showDetailButton = false;' #txt
Ls0 f14 responseActionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f14 responseMappingAction 'out=in;
' #txt
Ls0 f14 windowConfiguration '{/title "<%=ivy.cms.co(\"/labels/authentification\")%>"/width 0 /height 0 /centered true /resizable true /maximized false /close_after_last_rd true }' #txt
...
Ls0 f17 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
...
Ls0 f17 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f21 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f21 actionTable 'out=in;
' #txt
Ls0 f21 actionCode panel.getRootPane().setDefaultButton(panel.loginButton); #txt
Ls0 f21 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f2 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f22 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f22 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f22 actionTable 'out=in;
' #txt
Ls0 f22 actionCode 'import ch.ivyteam.ivy.common.util.UserPropertyUtil;
...
Ls0 f24 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f26 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f28 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
...
Ls0 f28 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f27 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f32 richDialogId ch.ivyteam.ivy.commondialogs.MessageDialog #txt
Ls0 f32 startMethod showMessage(String) #txt
Ls0 f32 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
Ls0 f32 requestActionDecl '<String message> param;' #txt
Ls0 f32 requestActionCode 'param.message = ivy.cms.co("/labels/setActiveEnvironmentFailedDescription", [in.setActiveEnvironmentException.getMessage()]);' #txt
Ls0 f32 responseActionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f32 responseMappingAction 'out=in;
' #txt
Ls0 f32 windowConfiguration '{/title "<%=ivy.cms.co(\"/labels/setActiveEnvironmentFailedTitle\")%>"/width 400 /height 150 /centered true /resizable true /maximized false /close_after_last_rd true }' #txt
...
Ls0 f37 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
Ls0 f37 actionTable 'out=in;
' #txt
Ls0 f37 actionCode 'ivy.log.info("Login failed: user {0} to login without success; reason {1}.", in.userName, in.error);' #txt
Ls0 f37 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
Ls0 f36 actionDecl 'ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData out;
' #txt
...
Ls0 f36 type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
...
>Proto Ls0 .type ch.ivyteam.ivy.commondialogs.LoginDialog.LoginDialogData #txt
