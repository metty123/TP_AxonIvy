[Ivy]
[>Created: Tue Aug 09 15:56:02 CEST 2011]
1314C971259DFE3C 3.17 #module
...
Es0 f0 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
...
Es0 f1 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f1 51 219 26 26 14 0 #rect
Es0 f1 @|RichDialogProcessEndIcon #fIcon
Es0 f3 guid 1180E7011B195DC0 #txt
Es0 f3 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f3 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
...
Es0 f4 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f4 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
...
Es0 f5 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f5 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
...
Es0 f14 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
Es0 f14 actionTable 'out=in;
' #txt
Es0 f14 actionCode 'import ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogHelper;
...
' #txt
Es0 f14 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
...
Es0 f16 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
Es0 f16 actionTable 'out=in;
' #txt
Es0 f16 actionCode panel.getRootPane().setDefaultButton(panel.okButton); #txt
Es0 f16 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
...
Es0 f18 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f18 method showError(ch.ivyteam.ivy.commons.data.technical.IvyResultStatus,Boolean,Boolean) #txt
...
<ch.ivyteam.ivy.commons.data.technical.IvyResultStatus ivyResultStatus,java.lang.Boolean showCopyButton,java.lang.Boolean showDetailButton> param = methodEvent.getInputArguments();
' #txt
...
Es0 f20 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
...
Es0 f22 richDialogId ch.ivyteam.ivy.commondialogs.ErrorDetailDialog #txt
Es0 f22 startMethod showDetailError(ch.ivyteam.ivy.commons.data.technical.IvyResultStatus) #txt
Es0 f22 type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
Es0 f22 requestActionDecl '<ch.ivyteam.ivy.commons.data.technical.IvyResultStatus ivyResultStatus> param;' #txt
Es0 f22 requestMappingAction 'param.ivyResultStatus=in.ivyResultStatus;
' #txt
Es0 f22 responseActionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData out;
' #txt
...
' #txt
>Proto Es0 .type ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogData #txt
