...
Ss0 f0 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
Ss0 f1 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
Ss0 f3 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
Ss0 f3 actionDecl 'ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData out;
' #txt
...
Ss0 f5 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
Ss0 f5 guid 118121E6235A4885 #txt
Ss0 f5 515 227 26 26 14 0 #rect
Ss0 f5 @|RichDialogEndIcon #fIcon
Ss0 f4 expr out #txt
Ss0 f4 528 74 528 227 #arcP
Ss0 f6 actionDecl 'ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData out;
' #txt
...
Ss0 f6 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
Ss0 f8 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
Ss0 f10 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
Ss0 f11 actionDecl 'ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData out;
' #txt
Ss0 f11 actionTable 'out=in;
' #txt
Ss0 f11 actionCode 'out.isCustomButtonsMode = false;' #txt
Ss0 f11 type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
...
' #txt
>Proto Ss0 .type ch.ivyteam.ivy.commondialogs.SingleLineInputDialog.SingleLineInputDialogData #txt
