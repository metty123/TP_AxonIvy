...
Ms0 f0 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
...
Ms0 f1 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
...
Ms0 f3 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
Ms0 f3 actionDecl 'ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData out;
' #txt
Ms0 f3 actionTable 'out=in;
' #txt
Ms0 f3 478 30 20 20 13 0 #rect
Ms0 f3 @|RichDialogProcessStartIcon #fIcon
Ms0 f4 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
Ms0 f4 guid 1180E404ABBE641C #txt
Ms0 f4 475 243 26 26 14 0 #rect
Ms0 f4 @|RichDialogEndIcon #fIcon
Ms0 f5 expr out #txt
Ms0 f5 488 50 488 243 #arcP
Ms0 f2 actionDecl 'ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData out;
' #txt
...
Ms0 f2 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
...
Ms0 f8 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
...
Ms0 f10 actionDecl 'ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData out;
' #txt
...
Ms0 f10 type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
...
' #txt
>Proto Ms0 .type ch.ivyteam.ivy.commondialogs.MessageDialog.MessageDialogData #txt
