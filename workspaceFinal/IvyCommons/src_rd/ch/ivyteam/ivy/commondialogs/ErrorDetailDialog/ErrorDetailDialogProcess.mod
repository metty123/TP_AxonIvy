[Ivy]
[>Created: Tue Aug 09 15:55:16 CEST 2011]
1314C55B6225F6E5 3.17 #module
...
Es0 f0 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
...
Es0 f1 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
Es0 f1 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData out;
' #txt
...
Es0 f2 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
Es0 f2 guid 1180E76072C5B80E #txt
Es0 f2 507 163 26 26 14 0 #rect
Es0 f2 @|RichDialogEndIcon #fIcon
Es0 f3 expr out #txt
Es0 f3 520 66 520 163 #arcP
Es0 f4 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
Es0 f4 51 163 26 26 14 0 #rect
Es0 f4 @|RichDialogProcessEndIcon #fIcon
Es0 f6 actionDecl 'ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData out;
' #txt
Es0 f6 actionTable 'out=in;
' #txt
Es0 f6 actionCode panel.getRootPane().setDefaultButton(panel.okButton); #txt
Es0 f6 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
...
Es0 f8 type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
Es0 f8 method showDetailError(ch.ivyteam.ivy.commons.data.technical.IvyResultStatus) #txt
...
<ch.ivyteam.ivy.commons.data.technical.IvyResultStatus ivyResultStatus> param = methodEvent.getInputArguments();
' #txt
Es0 f8 inActionCode 'import ch.ivyteam.ivy.commondialogs.ErrorDialog.ErrorDialogHelper;
import java.util.HashSet;
import ch.ivyteam.ivy.commons.data.technical.IvyResultStatus;
...
' #txt
>Proto Es0 .type ch.ivyteam.ivy.commondialogs.ErrorDetailDialog.ErrorDetailDialogData #txt
