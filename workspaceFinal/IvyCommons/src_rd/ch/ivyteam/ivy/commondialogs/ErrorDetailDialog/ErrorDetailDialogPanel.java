package ch.ivyteam.ivy.commondialogs.ErrorDetailDialog;
 ...
 * @since <%=date%>
 */
public class ErrorDetailDialogPanel extends RichDialogGridBagPanel implements IRichDialogPanel {
  /** Serial version id */
  ...
  public void initialize() {
    ...
    this.add(getOkButton(), new com.ulcjava.base.application.GridBagConstraints(0, 1, 1, 1, -1, -1,
        com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE,
        new com.ulcjava.base.application.util.Insets(0, 0, 0, 0), 0, 0));
  }
