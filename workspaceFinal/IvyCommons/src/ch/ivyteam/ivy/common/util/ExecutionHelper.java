...
public class ExecutionHelper {
   ...
   * @throws Exception
   */
  public static String getUserPropertyAsSystemUser(final String userName, final String propertyName)
      throws EnvironmentNotAvailableException, Exception {
    String propertyValue = null;

    propertyValue = Ivy.session().getSecurityContext().executeAsSystemUser(new Callable<String>() {
      public String call() throws Exception {
        ...
        if (user != null) {
          ...
          Ivy.log().error("Get property name {0} failed; user {1} not found.", propertyName, userName);
          return null;
        }
      }
    });
   ...
   * @throws Exception
   */
  public static boolean setUserPropertyAsSystemUser(final String userName, final String propertyName,
      final String propertyValue) throws EnvironmentNotAvailableException, Exception {
    ...
    return Ivy.session().getSecurityContext().executeAsSystemUser(new Callable<Boolean>() {
      public Boolean call() throws Exception {
        ...
        if (user != null) {
          ...
          Ivy.log().error("Set property name {0} with value {1} failed; user {2} not found.", propertyName,
