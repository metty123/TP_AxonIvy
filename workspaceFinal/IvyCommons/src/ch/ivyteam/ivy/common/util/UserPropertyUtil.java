...
public class UserPropertyUtil {
  ...
  private final static String ALLOWED_ENVIRONMENTS = "xivy.commons.allowedEnvironments";
  ...
  /**
   * Gets the user's allowed environments from its properties The list of environments are stored in the specific comma
   * separated user property value ex: "VTH, GRM, MT, Demo"
   * 
   * @param userName
   * @return list of strings (list of allowed environments that he can choose at login); if property value empty/null
   *         then it returns an empty list
   * @throws EnvironmentNotAvailableException
   * @throws Exception
   */
  public static List<String> getUserAllowedEnvironments(String userName) throws EnvironmentNotAvailableException,
      Exception {
   ...
   * 
   * @param userName
   * @return comma separated list of user's allowed environements (that he can choose at login); if no data, then it
   *         returns empty string
   * @throws EnvironmentNotAvailableException
   * @throws Exception
   */
  public static String getUserAllowedEnvironmentsAsString(String userName) throws EnvironmentNotAvailableException,
      Exception {
    String allowedEnvironments = ExecutionHelper.getUserPropertyAsSystemUser(userName, ALLOWED_ENVIRONMENTS);
    Ivy.log().debug("Processing the property name {0} with value {1} for the user {2}.", ALLOWED_ENVIRONMENTS,
        allowedEnvironments, userName);
   ...
   * @throws Exception
   */
  public static boolean setUserAllowedEnvironments(String userName, List<String> allowedEnvironments)
   ...
   * @throws Exception
   */
  public static boolean setUserAllowedEnvironmentsAsString(String userName, String allowedEnvironments)
      throws EnvironmentNotAvailableException, Exception {
