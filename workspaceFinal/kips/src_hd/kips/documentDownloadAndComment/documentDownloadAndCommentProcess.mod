[Ivy]
[>Created: Tue Apr 11 18:11:18 CEST 2017]
15B5DA93473A0001 3.19 #module
>Proto >Proto Collection #zClass
fs0 documentDownloadAndCommentProcess Big #zClass
fs0 RD #cInfo
fs0 #process
...
>Proto fs0 fs0 documentDownloadAndCommentProcess #zField
fs0 f0 guid 15A98EA81F76E55E #txt
fs0 f0 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f0 method start(kips.Document,String) #txt
fs0 f0 disableUIEvents true #txt
fs0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<kips.Document document,java.lang.String message> param = methodEvent.getInputArguments();
' #txt
fs0 f0 inParameterMapAction 'out.data.document=param.document;
out.data.message=param.message;
' #txt
fs0 f0 outParameterDecl '<kips.Document document,kips.Comment comment> result;
' #txt
fs0 f0 outParameterMapAction 'result.document=in.data.document;
result.comment=in.data.comment;
' #txt
...
fs0 f1 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f1 211 51 26 26 0 12 #rect
fs0 f1 @|RichDialogProcessEndIcon #fIcon
fs0 f2 expr out #txt
fs0 f2 109 64 211 64 #arcP
fs0 f3 guid 15A98EA8219E5A4D #txt
fs0 f3 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f3 actionDecl 'kips.documentDownloadAndComment.documentDownloadAndCommentData out;
' #txt
...
fs0 f4 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f4 guid 15A98EA821A7A680 #txt
fs0 f4 211 147 26 26 0 12 #rect
fs0 f4 @|RichDialogEndIcon #fIcon
fs0 f5 expr out #txt
fs0 f5 109 160 211 160 #arcP
fs0 f11 actionDecl 'kips.documentDownloadAndComment.documentDownloadAndCommentData out;
' #txt
...
' #txt
fs0 f11 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
...
fs0 f14 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f14 407 264 26 26 0 12 #rect
fs0 f14 @|RichDialogProcessEndIcon #fIcon
fs0 f8 guid 15A98EB235E7C8AB #txt
fs0 f8 type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
fs0 f8 actionDecl 'kips.documentDownloadAndComment.documentDownloadAndCommentData out;
' #txt
...
>Proto fs0 .type kips.documentDownloadAndComment.documentDownloadAndCommentData #txt
