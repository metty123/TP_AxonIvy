[Ivy]
[>Created: Sat Apr 29 10:54:46 CEST 2017]
15BB4E6E448BBF6D 3.19 #module
>Proto >Proto Collection #zClass
Ts0 appointmentCancelMentorProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 appointmentCancelMentorProcess #zField
Ts0 f0 guid 15B48B8E7123B4E0 #txt
Ts0 f0 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
...
Ts0 f1 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
Ts0 f1 211 51 26 26 0 12 #rect
Ts0 f1 @|RichDialogProcessEndIcon #fIcon
Ts0 f3 guid 015B48B8E71DBA53 #txt
Ts0 f3 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
Ts0 f3 actionDecl 'kips.appointmentCancelMentor.appointmentCancelMentorData out;
' #txt
...
Ts0 f7 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
Ts0 f7 guid 15B153E242987221 #txt
Ts0 f7 779 244 26 26 0 12 #rect
Ts0 f7 @|RichDialogEndIcon #fIcon
Ts0 f6 guid 15B48BDAD92D7641 #txt
Ts0 f6 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
...
Ts0 f13 actionDecl 'kips.appointmentCancelMentor.appointmentCancelMentorData out;
' #txt
...
IUser student = ivy.wf.getSecurityContext().findUser(in.data.appointment.appointment.getField("Student").toString());
...
String ATTENDEEStudent;
try{
	ATTENDEEStudent = student.eMailAddress;
	in.data.user.studentMail = student.eMailAddress;
	in.data.user.StudentFullName = student.getFullName();
}catch (NullPointerException e) {
    // It''s fine if User is null
}
...
Ts0 f13 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
...
' #txt
Ts0 f13 448 235 112 44 -37 -8 #rect
...
' #txt
Ts0 f12 225 145 30 30 -123 17 #rect
Ts0 f12 @|ErrorEndIcon #fIcon
Ts0 f4 expr out #txt
Ts0 f4 109 160 225 160 #arcP
Ts0 f17 beanConfig '"{/emailSubject ""appointment canceled""/emailFrom """"/emailReplyTo """"/emailTo ""<%=in.data.user.mentor.eMailAddress%>, <%=in.data.user.studentMail%>""/emailCC """"/emailBCC """"/exceptionMissingEmailAttachments ""false""/emailMessage ""Hallo,\\n\\nihr Termin am <%=in.data.appointment.date%> wurde von <%=in.data.user.StudentFullName%> abgesagt.\\n\\n\\n\\n""/emailAttachments {""<%=in.data.document.file%>""}}"' #txt
Ts0 f17 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
...
' #txt
Ts0 f17 617 235 128 44 -59 -8 #rect
Ts0 f17 @|EMailIcon #fIcon
Ts0 f5 expr out #txt
Ts0 f5 560 257 617 257 #arcP
Ts0 f10 expr out #txt
Ts0 f10 745 257 779 257 #arcP
Ts0 f8 expr out #txt
Ts0 f8 108 257 210 257 #arcP
Ts0 f8 0 0.4999999999999999 0 0 #arcLabel
Ts0 f14 expr out #txt
Ts0 f14 354 257 448 257 #arcP
Ts0 f9 actionDecl 'kips.appointmentCancelMentor.appointmentCancelMentorData out;
' #txt
Ts0 f9 actionTable 'out=in;
' #txt
Ts0 f9 dbSql '<?xml version=""1.0"" standalone=""no""?>
<!DOCTYPE DELETE SYSTEM  ""sqlStatements.dtd"">
<DELETE><Table name=''appointment''/><Condition><Relation kind=''=''><Column name=''AID''/><AnyExpression>in.data.appointment.id</AnyExpression></Relation></Condition></DELETE>' #txt
...
Ts0 f9 type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
...
' #txt
Ts0 f9 210 235 144 44 -67 -8 #rect
Ts0 f9 @|DBStepIcon #fIcon
>Proto Ts0 .type kips.appointmentCancelMentor.appointmentCancelMentorData #txt
