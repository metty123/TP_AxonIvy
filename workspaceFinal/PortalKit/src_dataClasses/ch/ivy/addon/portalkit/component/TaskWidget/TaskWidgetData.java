...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -9039672935748793769L;
  ...
  private ch.ivy.ws.addon.SortType sortType;

  /**
   * Gets the field sortType.
   * @return the value of the field sortType; may be null.
   */
  public ch.ivy.ws.addon.SortType getSortType()
  {
    return sortType;
  }

  /**
   * Sets the field sortType.
   * @param _sortType the new value of the field sortType.
   */
  public void setSortType(ch.ivy.ws.addon.SortType _sortType)
  {
    sortType = _sortType;
  }
